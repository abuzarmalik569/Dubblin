...
//     // { id: 4, title: "Lorem Ipsum is simply dummy text of the printing and typesetting industry.", image: blogimg6 },
//   ];

//   const trendpost=[ { id: 1, title: "when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived", image: blog7 },
...
//         <div className=' h-[90vh]  font-Outfit ' style={{backgroundImage:'url("/blogheader.png")',
//           backgroundPosition:'center',
//           backgroundRepeat: 'no-repeat',
//           backgroundSize:'cover'
//         }}>
//            <div className=' flex  h-full container mx-auto relative justify-center items-center'>
//            <div className=' space-y-4 mt-28'>
//            <h1 className=' text-5xl font-bold'>
//            Lorem Ipsum is simply dummy text of the
//            </h1>
//            <h2 className=' text-3xl text-center'>Lorem Ipsum is simply dummy text of the</h2>
//            </div>
//            <div className=' w-1/4 p-2 bg-white absolute top-9 right-0'>
//            <Image src={blogimg1} className=''/>
//            </div>
//            <div className=' w-1/6 p-2 bg-white absolute bottom-11 left-3'>
//            <Image src={blogimg1} className=''/>
//            </div>
//            </div>
...
//       <h2 className="text-center text-4xl font-bold text-black">Popular Post</h2>
//       <p className="text-center text-lg text-gray-500">Lorem Ipsum is simply dummy text of the printing industry.</p>
//       </div>

//       <div className="flex gap-4 mt-6">
        
//         <div className="col-span-1 w-1/2 p-4 space-y-2">
...
//           {posts.map((post) => (
//             <div key={post.id} className="flex space-x-6 mt-3 ">
//               <Image src={post.image} alt={post.title} className="rounded w-44 h-44 " />
//               <div className=' space-y-2'>
//                 <h4 className="font-bold text-black text-xl">{post.title}</h4>
...
//       }}
//       >
//         <div className=' h-full  w-full container mx-auto font-Outfit flex items-center '>
//         <div className=' w-2/5   '>
//            <h1 className=' font-bold text-3xl'>Lorem Ipsum is simply dummy </h1>
...
//         <h1 className="text-4xl font-bold text-black">Trending Post</h1>
...
//           <div
//             key={post.id}
//             className="flex flex-col justify-center gap-3 items-center w-[32%] mt-6"
//           >
//             {/* Image */}
//             <Image
//               src={post.image} // Replace with actual images
//               alt="Post Image"
             
//               className="w-full"
//             />
//             <p className=' text-black pl-2'>{post.title}</p>
//           </div>
//         ))}
//       </div>
//     </div>    
...
//       <div className=' w-1/2  flex items-center' style={{backgroundImage:'url("/bloglast1.png")',
//           backgroundPosition:'center',
//           backgroundRepeat: 'no-repeat',
//           backgroundSize:'cover'
//         }}>
//           <p className='w-1/2 text-lg ml-10 mt-36'>when an unknown printer took a galley of type and scrambled it to make a type specimen
//           book</p>
//        </div>
//        <div className=' w-[20%]'>
//            <Image src={bloglast2} />
