...
//     const [capacity, setCapacity] = useState(product.sizes[0]);
...
//                 <h1 className="text-xl font-semibold"> <a href="/product-details">{selectedBottle.name}</a></h1>
...
//                         {selectedBottle.colors.map((color) => (
//                             <button
//                                 key={color.name}
