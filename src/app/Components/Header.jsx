    ...
    <header className="relative font-Outfit">
          ...
          <div className="flex h-16 items-center justify-between lg:justify-start lg:space-x-8">
            ...
            <div className="flex items-center space-x-8">
              ...
              <div className="flex items-center space-x-4">
                ...
                {[User, ShoppingCart].map((Icon, idx) => (
                  <button key={idx} className="text-gray-700 hover:text-gray-900 transition-colors duration-200">
                    <Icon className="h-5 w-5" />
                  </button>
                ))}
                <button
      ...
      >
        <div className="flex justify-between items-center p-4 border-b">
          ...
          />
          <div className="flex items-center space-x-4">
            <button onClick={toggleSearch} className="text-gray-700 hover:text-gray-900 transition-colors duration-200">
              <Search className="h-5 w-5" />
            </button>
      ...
      <div
        ref={searchBarRef}
        className={`absolute top-full left-0 right-0 bg-white shadow-md p-4 z-50 opacity-0 -translate-y-4`}
      >
...
<div class="w-2/3 mx-auto">
  <input
  ref={searchInputRef}
    class="w-full peer z-[21] px-6 py-4 rounded-xl outline-none duration-200 ring-2 ring-pink-200  focus:ring-pink-500"
    color="white"
    size="xl"
    placeholder="Focus me"
  />
  <div
    class="opacity-0 mt-5 -translate-y-2 peer-focus:translate-y-0 pointer-events-none peer-focus:pointer-events-auto duration-200 peer-focus:opacity-100 absolute top-16 w-full z-[500] left-0 rounded-xl border border-white-222 p-4 bg-white shadow-lg"
  >
    <p class="font-semibold text-xs text-[#5D5D5F]">LAST SEARCHES</p>
    <ul class="flex gap-2 flex-col mt-2">
      <li
        class="px-2 cursor-pointer text-sm hover:bg-pink-100 py-2 rounded-lg"
      >
