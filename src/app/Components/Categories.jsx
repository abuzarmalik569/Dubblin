...
//       {/* Heading */}
//       <div className="text-center mt-14 font-Outfit text-xl">
//         <h2 className="font-semibold">Discover Our Categories</h2>
...
//       {/* Filter */}
//       <div className="flex font-Outfit text-center justify-center gap-20 mt-10 mb-10">
//         {categories.map(category => (
//           <div
//             key={category.id}
//             className={`cursor-pointer flex flex-col items-center ${activeCategory === category.id ? 'font-semibold text-pink-700' : ''}`}
...
//       {/* Products */}
//       <div className="font-Outfit text-lg flex flex-wrap justify-center gap-20">
...
//               <h3 className="text-pink-700 line-through">Rs.{product.oldPrice.toFixed(2)}</h3>
//             </div>
//           </div>
//         ))}
//       </div>
