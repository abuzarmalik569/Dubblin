            ...
            <div className='w-full md:w-1/2 bg-slate-50 py-10'>
                <div className="p-4">
                    <div className="w-11/12 mx-auto p-6 bg-slate-50">
                        {cartItems.map((item) => (
                            <div key={item.id} className="flex flex-col sm:flex-row items-center justify-around mb-4">
                                <div className='w-full sm:w-1/4 mb-2 sm:mb-0'>
                                    <Image src={item.image} alt={item.name} className="w-full h-auto rounded" />
                                </div>
