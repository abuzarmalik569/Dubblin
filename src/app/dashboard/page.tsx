...
const Page: React.FC = () => {
  ...
  return (
    <div className="font-Outfit">
      {/* Header Section */}
      <header style={{ backgroundImage: "url('/profiletop.png')" }} className="p-32 bg-cover bg-center"></header>
              ...
              <div className="bg-gray-100 md:w-1/2 w-full shadow-md rounded-md p-6">
                ...
                <div className="flex justify-between">
                  <div className="space-y-3">
                    ...
                    <button className="text-black hover:underline">Reset password</button>
                  </div>
                  <div className="space-y-3">
